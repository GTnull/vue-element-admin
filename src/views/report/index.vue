...
<div class="grid-content bg-purple">
    ...
    <el-row :gutter="40">
        <el-col :span="8">
            <el-tree ref="eltree" icon-class="el-icon-eleme" :data="treeData" node-key="id" :default-expand-all="true" :default-checked-keys="checkedKeys" :expand-on-click-node="false" :highlight-current="true" :render-content="renderContent" @node-click="handleNodeClick" />
        </el-col>
        <el-col :span="16">
            <el-row>
            ...
            <el-row>
                <div v-if="selectKey.split('.').length === 3">
                    ...
                    <el-button :loading="loading" size="mini" type="primary" @click="submitAndNext">
                        提交并填写下一项
                    </el-button>
                </div>
